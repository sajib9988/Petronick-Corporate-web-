...
export default function CompanyCard({ company, index = 0 }: CompanyCardProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="
          pointer-events-none absolute -inset-[2px] -z-10 rounded-[22px]
          bg-gradient-to-r from-[#F97316] via-[#FB923C] to-[#FBBF24]
  ...
  {index + 1}
        ...
        <div className="flex w-full items-center justify-center gap-3">
          ...
          <div className="min-w-0 text-left">
            ...
            {company.category && (
              <p className={`mt-0.5 truncate text-xs font-semibold ${meta.text}`}>
                {company.category}
              </p>
            )}
          </div>
...
<p className="mt-1 line-clamp-3 text-left text-[15px] font-semibold leading-snug text-gray-800">
  {company.description}
</p>

       {/* FOOTER */}
<div className="mt-auto flex w-full items-center justify-between gap-11 pt-3">
  <Link
  ...
  {company.website ? (
    <a
      ...
      className="
        ...
        border border-gray-200 px-4 py-2.5 text-[12px] font-semibold text-gray-700
    ...
    <span
      className="
        ...
        border border-gray-100 px-4 py-2.5 text-[12px] font-medium text-gray-300
      "
    >
      Website
    </span>

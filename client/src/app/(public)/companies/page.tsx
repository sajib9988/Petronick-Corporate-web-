  ...
  return (
    <main className="min-h-screen overflow-hidden bg-slate-50">
      ...
      <section className="relative isolate overflow-hidden bg-[#0a0f14] text-white">
        ...
        <Container>
          <div className="relative flex min-h-[650px] flex-col items-center justify-center px-0 py-24 text-center">
            ...
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="mt-7 max-w-5xl text-5xl font-bold leading-[1.04] tracking-tight sm:text-6xl lg:text-7xl"
            >
              Our{" "}
            ...
            >
              ...
              Holdings LLC and discover the specialized companies that form
              our connected business ecosystem.
            </motion.p>
          ...
          <div className="grid grid-cols-1 divide-y divide-slate-200 sm:grid-cols-3 sm:divide-x sm:divide-y-0">
            ...
            {[
              ...
              },
              {
                ...
                description: "Shared capabilities",
                icon: Network,
              ...
              return (
                <motion.div
                  ...
                  className="flex items-center justify-center gap-4 px-6 py-8 transition-colors duration-300 hover:bg-slate-50"
                >
                  <div
        ...
        <Container>
          ...
          >
            ...
            <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-slate-500 sm:text-base">
              ...
              companies that operate independently while benefiting from
              shared expertise, marketing, logistics, fulfillment,
        ...
        <Container>
          ...
          >
            ...
            <p className="max-w-md text-sm leading-7 text-slate-500 sm:text-right">
              Discover the specialized companies operating across digital
              services, commerce, fulfillment, advisory, product
              development, and specialty markets.
            </p>
          </motion.div>
            ...
            {companies.map((company: any) => {
              ...
              return (
                <motion.article
                  ...
                  className="group flex h-full flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:border-slate-300 hover:shadow-2xl hover:shadow-slate-200/60"
                >

                  {/* Top Accent */}

                  <div className="h-1 w-full bg-gradient-to-r from-emerald-500 via-cyan-400 to-emerald-400 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                  ...
                  <div className="flex items-start gap-5 p-7 pb-5">
                    ...
                    <div className="shrink-0">
                      ...
                      {company.logo ? (
                        ...
                        <div
                          className={`flex h-16 w-16 items-center justify-center rounded-2xl ${color} shadow-sm transition-transform duration-300 group-hover:scale-105`}
                        >
                    ...
                    <div className="min-w-0 flex-1 pt-1">
                      ...
                      <h2 className="text-[17px] font-bold leading-tight tracking-tight text-slate-950">
                        {company.name}
                      </h2>
        ...
        <Container>
          ...
          >
            ...
            <div className="relative mx-auto max-w-3xl text-center">
              ...
              >
                Represent one or multiple Petronick Corporate Holdings
                companies and help introduce our products, services, and
                opportunities to businesses and consumers.
              </motion.p>
      ...
      <section className="bg-white py-20 sm:py-24">
        <Container>
          ...
          >
            ...
            <h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl">
              Explore the Companies Behind
              <br className="hidden sm:block" />
              Petronick Corporate Holdings LLC
            </h2>

            <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-slate-500 sm:text-base">
              Discover our growing portfolio of specialized businesses
              and learn how each company contributes to the broader
              Petronick ecosystem.
            </p>
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              ...
              <Link
                href="#companies"
                className="group inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-slate-950 px-6 text-sm font-semibold text-white transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
              >
                View Our Companies
              ...
              <Link
                href="/contact"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-6 text-sm font-semibold text-slate-700 transition-all duration-300 hover:-translate-y-1 hover:border-slate-300 hover:shadow-lg"
              >
                Contact Us
              </Link>

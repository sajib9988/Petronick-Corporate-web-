...
${company.isVisible
            ? "border-gray-200 hover:border-orange-400 hover:shadow-[0_0_20px_rgba(249,115,22,.45),0_0_50px_rgba(249,115,22,.30)]"
        ...
        <div className="relative flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            {company.revenueStage && (
              <span
                className={`rounded-full px-3 py-1 text-[11px] font-semibold tracking-wide ${stageColors[company.revenueStage] ??

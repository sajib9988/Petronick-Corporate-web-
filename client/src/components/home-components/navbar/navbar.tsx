          ...
          <nav className="hidden lg:flex items-center gap-12">
            {navLinks.map((link) => (
              <Link
                ...
                href={link.href}
                className={cn(
                  "relative h-20 flex items-center text-[16px] font-semibold tracking-wide transition-all duration-300 group",
                  isActive(link.href)
                    ? "text-amber-400"
